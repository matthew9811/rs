/*
 ...
 Source Schema         : rs_bulid

 Target Server Type    : MySQL
 Target Server Version : 50721
 File Encoding         : 65001

 Date: 02/09/2019 17:21:50
*/
...
CREATE TABLE `sys_data`  (
  `type_label` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '键',
  `type_value` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1' COMMENT '值',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '状态',
  `type_code` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据编码',
  `is_default` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否默认',
  `list_css` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'table回显样式',
  `type_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类型编号',
  `type_css` varchar(21) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '样式属性',
  ...
  INDEX `type_no`(`type_no`) USING BTREE,
  CONSTRAINT `type_no` FOREIGN KEY (`type_no`) REFERENCES `sys_dict` (`type_no`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_data
-- ----------------------------
INSERT INTO `sys_data` VALUES ('正常', '1', '1', '1', '1', 'primary', 'sys_dict_status', '', '', 'admin', '2019-09-02 16:57:56', NULL, NULL);
INSERT INTO `sys_data` VALUES ('禁用', '0', '1', '2', '0', 'danger', 'sys_dict_status', '', '', 'admin', '2019-09-02 16:58:19', NULL, NULL);
INSERT INTO `sys_data` VALUES ('是', '1', '1', '3', '1', 'primary', 'yes_or_no', '', '', 'admin', '2019-09-02 16:59:21', NULL, NULL);
INSERT INTO `sys_data` VALUES ('否', '0', '1', '4', '0', 'danger', 'yes_or_no', '', '', 'admin', '2019-09-02 16:59:39', NULL, NULL);
INSERT INTO `sys_data` VALUES ('菜单', '1', '1', '5', '1', 'default', 'menu_type', '', '', 'admin', '2019-09-02 17:00:51', NULL, NULL);
INSERT INTO `sys_data` VALUES ('目录', '2', '1', '6', '0', 'info', 'menu_type', '', '', 'admin', '2019-09-02 17:01:19', NULL, NULL);
INSERT INTO `sys_data` VALUES ('按钮', '3', '1', '7', '0', 'success', 'menu_type', '', '', 'admin', '2019-09-02 17:01:37', NULL, NULL);
...
CREATE TABLE `sys_dict`  (
  ...
  `type_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类型编号',
  `type_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类型名',
...
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES (26, 'sys_dict_status', '字典状态', 'admin', '2019-09-02 16:30:19', NULL, NULL, '1', '');
INSERT INTO `sys_dict` VALUES (27, 'yes_or_no', '系统是否', 'admin', '2019-09-02 16:30:38', NULL, NULL, '1', '');
INSERT INTO `sys_dict` VALUES (29, 'menu_type', '菜单类型', 'admin', '2019-09-02 17:00:08', NULL, NULL, '1', '');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('01e6acc7-1fd0-4b91-b22a-ea0bcb3ec001', '25d0981f-2a5e-4700-b517-7aa6cb7c94a2', '111', '111', 101, '111', NULL, '111', 'admin', '2019-08-30 17:26:28', 'admin', '2019-08-30 17:30:39', '0', NULL);
...
INSERT INTO `sys_menu` VALUES ('42153358-8504-46c1-99f7-737f19629adc', '', '2', '2', 33, '2', NULL, '2', 'admin', '2019-08-30 22:34:44', 'admin', '2019-08-30 22:34:49', '0', NULL);
INSERT INTO `sys_menu` VALUES ('4a51cbb8-c8bc-439b-8f8f-240f3b5e6c45', '', '1', '1', 1, '1', NULL, '1', 'admin', '2019-08-30 22:30:23', 'admin', '2019-08-30 22:30:27', '0', NULL);
INSERT INTO `sys_menu` VALUES ('555fec07-84fa-4256-88db-3dc69b4b7f85', '', '4', '5', 4, '4', NULL, '4', 'admin', '2019-08-30 22:39:50', 'admin', '2019-08-30 22:44:37', '0', NULL);
INSERT INTO `sys_menu` VALUES ('7415acc9-4ee3-4dd2-9305-3aeb2be8bd16', '', '5', '5', 5, '5', NULL, '5', 'admin', '2019-08-30 22:37:20', 'admin', '2019-08-30 22:37:47', '0', NULL);
INSERT INTO `sys_menu` VALUES ('a2bda5b9-3930-4b6b-84ee-07f3b74f1675', '', '1', '1', 1, '1', NULL, '1', 'admin', '2019-08-30 22:25:42', 'admin', '2019-08-30 22:25:55', '0', NULL);
INSERT INTO `sys_menu` VALUES ('bda1b9d6-8f44-4840-823a-89b68001a3dd', '', '1', '1', 1, '1', NULL, '1', 'admin', '2019-08-31 00:17:48', 'admin', '2019-08-31 00:18:04', '0', NULL);
INSERT INTO `sys_menu` VALUES ('d21314ab-8b6a-4a92-8c30-14d28f1a16a0', '0', '/test/test', '测试', 100, '测试', NULL, '1', 'admin', '2019-08-27 13:49:59', NULL, NULL, '1', NULL);
INSERT INTO `sys_menu` VALUES ('fef79151-ae64-4851-bffb-f78768ff5530', '25d0981f-2a5e-4700-b517-7aa6cb7c94a2', '21321', '213', 11, '32', NULL, '1321', 'admin', '2019-08-30 22:17:16', 'admin', '2019-08-30 22:17:39', '0', NULL);
