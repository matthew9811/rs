...
CREATE TABLE `sys_data`  (
  ...
  `css` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES ('7a4f3f15-fad0-4665-a080-e28cd44089b9', '菜单样式', '0', 'admin', '2019-07-13 11:48:57', NULL, NULL, '1', '1', '');
