...
CREATE TABLE `com_sub`  (
  ...
  `stu_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学号',
  `sub_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程编号',
  `sub_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程名称',
...
-- Records of com_sub
-- ----------------------------
INSERT INTO `com_sub` VALUES ('1624723761812934656', '17210210613', 'GE6045', '高等数学Ⅱ(计算机类)', 30.00, 4.00, NULL, NULL, NULL, NULL, NULL, '1');
INSERT INTO `com_sub` VALUES ('1625498440257441792', '17210210613', 'GE6001', '线性代数', 55.00, 3.00, NULL, NULL, NULL, NULL, NULL, '1');
...
CREATE TABLE `sub_opt`  (
  ...
  `sub_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程名称\r\n',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '审核状态\r\n',
...
-- Records of sub_opt
-- ----------------------------
INSERT INTO `sub_opt` VALUES ('1627305737640153088', '17210210613', 0x31303638353235, '高等数学Ⅱ(计算机类)', '0', NULL, NULL, NULL, '2019-05-16 23:43:07', NULL, NULL, NULL, '1');
...
CREATE TABLE `sub_replace`  (
  `id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `sub_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '原课程编号\r\n',
  `sub_replace_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '替代课程编号',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Records of sub_replace
-- ----------------------------
INSERT INTO `sub_replace` VALUES ('1626447191176318976', 'GE6001', 'GE6002', NULL, '2019-05-14 14:51:36', NULL, NULL, NULL, '1');
INSERT INTO `sub_replace` VALUES ('1626454863523024896', 'GE6045', 'GE6047', NULL, '2019-05-14 15:22:08', '2019-05-14 16:06:52', NULL, NULL, '1');
INSERT INTO `sub_replace` VALUES ('1627087573769719808', 'IN3027', 'GE6002', NULL, '2019-05-16 09:16:14', '2019-05-16 09:18:37', NULL, NULL, '1');
INSERT INTO `sub_replace` VALUES ('1627088059231047680', 'GE6001', 'IN3028', NULL, '2019-05-16 09:18:21', NULL, NULL, NULL, '1');
INSERT INTO `sub_replace` VALUES ('1627092743941459968', 'GE6001', 'GE6046', NULL, '2019-05-16 09:36:46', NULL, NULL, NULL, '1');
...
CREATE TABLE `subject`  (
  `id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `sub_carry_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '开课编号',
  `sub_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程编号',
  `sub_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程名称',
  `sub_institute` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '开课院系',
  `sub_credit` decimal(11, 2) NULL DEFAULT NULL COMMENT '学分',
  `sub_class_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '教学班名称',
  `sub_men_count` int(4) NULL DEFAULT NULL COMMENT '已有人数\r\n',
  `sub_men_total_count` int(4) NULL DEFAULT NULL COMMENT '总人数\r\n',
  `sub_plan_type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '计划类型',
  ...
  `sub_teacher_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '教师id\r\n',
  `sub_course_type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '选课类型',
  `sub_course_genre` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程类别',
  `replace` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否为替代课程\r\n',
  `sub_status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程状态，0可选，1已满',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  ...
  `sub_address` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上课地点',
  `sub_week_day` int(2) NULL DEFAULT NULL COMMENT '上课星期几',
  `sub_period` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上课节次',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of subject
-- ----------------------------
INSERT INTO `subject` VALUES ('1622183620053504000', '1066758', 'GE6001', '线性代数', '基础教学院', 3.00, '01-18网络1-2班', 1, 50, '培养方案', 48, 48, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'F103', 1, '1,2');
INSERT INTO `subject` VALUES ('1622184227275476992', '1066760', 'GE6001', '线性代数', '基础教学院', 3.00, '02-18网络3-4班', 1, 50, '培养方案', 48, 48, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'F203', 2, '3,4');
INSERT INTO `subject` VALUES ('1622184330178531328', '1066762', 'GE6001', '线性代数', '基础教学院', 3.00, '03-18网络5-6班', 1, 50, '培养方案', 48, 48, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'F201', 1, '1,2');
INSERT INTO `subject` VALUES ('1622184482679230464', '1066764', 'GE6001', '线性代数', '基础教学院', 3.00, '04-18网络7-8班', 1, 50, '培养方案', 48, 48, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'E109', 3, '1,2');
INSERT INTO `subject` VALUES ('1622185006526828544', '1068515', 'GE6045', '高等数学Ⅱ(计算机类)', '基础教学院', 4.00, '04-18电子1-2班', 1, 50, '培养方案', 64, 64, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'E103', 2, '5,6');
INSERT INTO `subject` VALUES ('1622185625115365376', '1068517', 'GE6045', '高等数学Ⅱ(计算机类)', '基础教学院', 4.00, '05-18电子3-4班', 1, 50, '培养方案', 64, 64, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'E108', 1, '5,6');
INSERT INTO `subject` VALUES ('1622185704173801472', '1068519', 'GE6045', '高等数学Ⅱ(计算机类)', '基础教学院', 4.00, '06-18电子5-6班', 1, 50, '培养方案', 64, 64, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'F102', 1, '7,8');
INSERT INTO `subject` VALUES ('1622185793302761472', '1068521', 'GE6045', '高等数学Ⅱ(计算机类)', '基础教学院', 4.00, '01-18网络1-2班', 1, 50, '培养方案', 64, 64, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'F104', 1, '1,2');
INSERT INTO `subject` VALUES ('1622185859967029248', '1068523', 'GE6045', '高等数学Ⅱ(计算机类)', '基础教学院', 4.00, '02-18网络3-4班', 1, 50, '培养方案', 64, 64, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'F105', 1, '3,4');
INSERT INTO `subject` VALUES ('1622185944041852928', '1068525', 'GE6045', '高等数学Ⅱ(计算机类)', '基础教学院', 4.00, '03-18网络5-6班', 1, 50, '培养方案', 64, 64, 0, '001', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'E107', 2, '1,2');
INSERT INTO `subject` VALUES ('1623259656006602752', '1070867', 'IN3027', '程序设计基础(Java)', '国际教育学院', 4.00, '01-18软工联合1班', NULL, 50, '培养方案', 64, 48, 8, '003', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'E201', 2, '3,4');
INSERT INTO `subject` VALUES ('1623262454123270144', '1070868', 'IN3027', '程序设计基础(Java)', '国际教育学院', 4.00, '02-18软件联合专1班,18软工留学1班', NULL, 50, '培养方案', 64, 48, 8, '004', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, '1', 1, 'F204', 3, NULL);
...
CREATE TABLE `sys_data`  (
  ...
  `type_css` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '样式',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  ...
  `type_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '字典编号',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_dict`  (
  ...
  `type_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类型编号',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('110f538c-85cf-4df7-9520-030a7f1b7059', '0', '/admin/user', '用户菜单', 3, '&#xe66f', NULL, 'sys:system:user', 'admin', '2019-06-26 15:07:02', NULL, NULL, '1', NULL);
INSERT INTO `sys_menu` VALUES ('7a6016e5-fa26-4661-9592-62ffb109e3e7', '0', '/admin/menu', 'test', 1, '1', NULL, '1', 'admin', '2019-06-26 14:48:23', NULL, NULL, '1', NULL);
INSERT INTO `sys_menu` VALUES ('e3cd62a2-7060-4355-ad41-c02887f67d55', '0', '/admin/dict', '字典管理', 4, '&#xe705', NULL, 'sys:system:dict', 'admin', '2019-06-26 15:44:55', NULL, NULL, '1', NULL);
...
-- ----------------------------
INSERT INTO `sys_role_user` VALUES ('1', '17210210613', '1', NULL, NULL, NULL, NULL, NULL, '1');
